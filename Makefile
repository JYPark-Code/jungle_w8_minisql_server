...
.PHONY: all clean test tsan valgrind bench loadtest repl \
        test_storage_all \
        test_bptree test_benchmark test_index_registry test_engine_lock test_threadpool test_trie
...
# 회귀 테스트 (W7 + 추후 W8)
# ---------------------------------------------------------------------------
test: $(TEST_PARSER_EXEC) test_storage_all test_bptree test_benchmark test_index_registry test_engine_lock test_threadpool test_trie
	./$(TEST_PARSER_EXEC)
...
# ---------------------------------------------------------------------------
valgrind: $(TEST_PARSER_EXEC) $(STORAGE_TEST_TARGETS) test_bptree test_benchmark test_index_registry test_engine_lock test_threadpool test_trie
